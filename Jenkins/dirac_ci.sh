...
############################################
DIRAC_INSTALL='https://raw.githubusercontent.com/DIRACGrid/DIRAC/rel-v6r14/Core/scripts/dirac-install.py'
DIRAC_PILOT='https://raw.githubusercontent.com/DIRACGrid/DIRAC/rel-v6r14/WorkloadManagementSystem/PilotAgent/dirac-pilot.py'
DIRAC_PILOT_TOOLS='https://raw.githubusercontent.com/DIRACGrid/DIRAC/rel-v6r14/WorkloadManagementSystem/PilotAgent/pilotTools.py'
DIRAC_PILOT_COMMANDS='https://raw.githubusercontent.com/DIRACGrid/DIRAC/rel-v6r14/WorkloadManagementSystem/PilotAgent/pilotCommands.py'
DIRAC_INSTALL_SITE='https://github.com/DIRACGrid/DIRAC/raw/rel-v6r14/Core/scripts/install_site.sh --no-check-certificate'
